package oit.is.group5.lec04.security;
...
public class Sample3AuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails user1 = users
        .username("user1")
        .password("$2y$10$Ohj5.T.yzeya8pHzV/KXQ.MvWnjiq65sLzuFrIcHnx8xudOVYUQZa")
        .roles("USER")
        .build();
    UserDetails user2 = users
        .username("user2")
        .password("$2y$10$H/86fKM1fNfZafRq6Ydq.Olfcbh48.Pmdis.B6MU5kwN7uW21UOQW")
        .roles("ADMIN")
        .build();
